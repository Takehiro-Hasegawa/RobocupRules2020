...
幅（ゴールライン）：約9 m  
### ゴールエリア
各ゴールポストの内側から [ KidSizeは ~~1.2~~ 0.2m , AdultSizeは 0.7m ] の位置に、ゴールライン[から]線を引きます。 これらの線は、1 mの距離でフィールド内に広がり、ゴールラインと平行に描かれた線でつながっています。 これらのラインとゴールラインで囲まれたエリアがゴールエリアです。  
### ペナルティエリア
